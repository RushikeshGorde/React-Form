...
export default function FirstStep() {
    ...
    return (
        <div className='perdet'>
            <div className="Personal shadow-lg p-3 mb-5 bg-transperent rounded">
                ...
                <div className='bg-transperent text-light'>
                    <TextField label="First name" value={userData['firstname']} onChange={(e) => setUserData({ ...userData, "firstname": e.target.value })} margin="normal" varient="outlined" color="secondary" />
                </div>

                <div>
                    <TextField className='ip' label="Last name" value={userData['lastname']} onChange={(e) => setUserData({ ...userData, "lastname": e.target.value })} margin="normal" varient="outlined" color="secondary" />
                </div>
                <div>
                ...
                <div>
                    <Button className='btn btn-outline-light' variant="contained" onClick={() => setStep(2)}>Next</Button>
                </div>
            </div>
        </div>
    )
